...
class CartoonData {
  ...
  static final List<Cartoon> allCartoons = <Cartoon>[
    ...
    Cartoon(
      ...
      characterName: 'بچه‌ها، مامان، بابا و دوستان',
      category: CartoonCategoryType.preschool,
      categoryLabel: 'خردسالان و نوپا',
      description: 'محبوب‌ترین ترانه‌های کودکانه جهان با کارتون‌های شاد و رنگارنگ؛ آهنگ‌های خواب، حمام، شمارش و الفبا که کودکان ایران عاشقش هستند.',
      coverEmoji: '🎶',
    ...
    Cartoon(
      ...
      category: CartoonCategoryType.comedy,
      categoryLabel: 'طنز و خنده‌دار',
      description: 'دوست‌داشتنی‌ترین موجودات زرد دنیا که با زبان بامزه‌شان و شیطنت‌های بی‌پایان کودکان را می‌خندانند.',
      coverEmoji: '🍌',
    ...
    Cartoon(
      ...
      description: 'انیمیشن سینمایی پرمخاطب درباره نوزادی با کت‌وشلوار و کراوات که مثل یک رئیس اداره‌ی شرکت می‌شود و با برادرش ماجراجویی می‌کند.',
      coverEmoji: '👶',
      themeColor: Color(0xFF0984E3),
      gradient: LinearGradient(
    ...
    Cartoon(
      ...
      category: CartoonCategoryType.adventure,
      categoryLabel: 'ماجراجویی و نجات',
      description: 'محبوب‌ترین کارتون ماشین‌ها با شخصیت لایتنینگ مک‌کویین که در مسابقه‌ها و ماجراجویی‌های جاده‌ای دوستی و پشتکار را یاد می‌گیرد.',
      coverEmoji: '🏎️',
    ...
    Cartoon(
      ...
      category: CartoonCategoryType.adventure,
      categoryLabel: 'ماجراجویی و نجات',
      description: 'پاندا شجاع و مهربان با تمرین و پشتکار یاد می‌گیرد هر کسی با تلاش و باور به خود می‌تواند یک قهرمان بزرگ باشد.',
      coverEmoji: '🐼',
      themeColor: Color(0xFFE74C3C),
      gradient: LinearGradient(
        colors: [Color(0xFFE74C3C), Color(0xFFC0392B)],
    ...
    Cartoon(
      ...
      category: CartoonCategoryType.adventure,
      categoryLabel: 'ماجراجویی و نجات',
      description: 'پسر نوجوانی به نام بن با ساعت فضایی اومنیتریکس می‌تواند به موجودات قدرتمند تبدیل شود و با دشمنان مبارزه کند. یکی از پرمخاطب‌ترین کارتون‌های نوجوانان با دوبله فارسی.',
      coverEmoji: '👾',
    ...
    Cartoon(
      ...
      category: CartoonCategoryType.cinema,
      categoryLabel: 'سینمایی و بلند',
      description: 'محبوب‌ترین انیمیشن سینمایی ایرانی درباره کارگاه اسباب‌بازی‌های ساخت ایران و تلاش علی برای بازگرداندن امید و شادی.',
      coverEmoji: '🧸',
      themeColor: Color(0xFFE84393),
      gradient: LinearGradient(
        colors: [Color(0xFFE84393), Color(0xFFFF7675)],
    ...
    Cartoon(
      ...
      category: CartoonCategoryType.iranian,
      categoryLabel: 'ایرانی و آموزنده',
      description: 'پرمخاطب‌ترین انیمیشن کوتاه ایرانی با پیام‌های محیط‌زیستی و آموزشی به زبان ساده و خنده‌دار.',
      coverEmoji: '🐾',
    ...
    Cartoon(
      ...
      category: CartoonCategoryType.iranian,
      categoryLabel: 'ایرانی و آموزنده',
      description: 'انیمیشن پرمخاطب شبکه پویا درباره دو بره دوست‌داشتنی که با کنجکاوی و کمک پدر و مادر مهارت‌های زندگی را یاد می‌گیرند.',
      coverEmoji: '🐑',
