...
class FandoqiHubs {
  static const HubData farsi = HubData(
    ...
    activities: [
      ...
      HubActivity(
        title: 'املای شنیداری',
        subtitle: 'گوش کن و کلمهٔ درست را پیدا کن',
        emoji: '👂',
        route: '/dictation',
        gameName: 'املا',
        isFree: true,
  ...
  static const HubData math = HubData(
    ...
    activities: [
      ...
      HubActivity(
        title: 'جمع و تفریق تا ۲۰',
        subtitle: 'مهره بشمار؛ فقط جمع و تفریق کتاب اول',
        emoji: '➕',
        route: '/math/add',
        gameName: 'جمع',
        isFree: true,
      ...
      HubActivity(
        title: 'قاب ده‌تایی',
        subtitle: 'ساخت عدد با ۱۰ خانه؛ زبان کتاب ریاضی اول',
        emoji: '🟥',
      ...
      HubActivity(
        title: 'تمساح بزرگ‌تر و کوچک‌تر',
        subtitle: 'دهان تمساح همیشه به سمت عدد بزرگ باز است',
        emoji: '🐊',
        route: '/math/compare',
        gameName: 'تمساح',
        isFree: true,
      ...
      HubActivity(
        title: 'ساعت کامل',
        subtitle: 'خواندن ساعت‌های رند مثل ۳ و ۷',
        emoji: '🕐',
        route: '/math/clock',
        gameName: 'ساعت',
        isFree: true,
  ...
  static const HubData art = HubData(
    ...
    activities: [
      ...
      HubActivity(
        title: 'آلبوم نقاشی من',
        subtitle: 'نقاشی‌هایی که خودت ذخیره کردی، روی همین گوشی',
        emoji: '🖼️',
        route: '/drawing-album',
        gameName: 'آلبوم نقاشی',
        isFree: true,
      ),
      HubActivity(
